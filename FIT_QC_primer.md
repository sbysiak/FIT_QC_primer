...
After awhile your task will be Configured (STANDBY -> DEPLOYED -> <p style='color:orange'> CONFIGURED </p>). If the status turns to be <span style="color:red"> ERROR text</span> then something went wrong with the configurations.
